  ...
  return (
    <div className="bg-[#2699fb] p-4">
      <div className="max-w-[1240px] py-[15px] items-center  flex justify-between mx-auto">
        ...
        {
            tooggle?
            <MdOutlineMenu onClick={()=>setToggle(!tooggle)}className="text-white text-2xl md:hidden block"/>
            :
            <IoIosCloseCircleOutline onClick={()=>setToggle(!tooggle)} className="text-white text-2xl md:hidden block" />
